#ifndef _HTTP_RESOURCES_
#define _HTTP_RESOURCES_

#include "../include/http/request.h"

typedef struct server_resource_map;
...
} server_resource_access;

#define HTT_RESOURCE_ACCESS_OK 0
#define HTT_RESOURCE_ACCESS_DENIED 1
